...
yystate(105, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(105, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(100, [122|Ics], Line, Tlen, _, _) ->
    yystate(102, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(100, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 114 ->
    yystate(102, Ics, Line, Tlen+1, 6, Tlen);
yystate(100, [C|Ics], Line, Tlen, _, _) when C >= 116, C =< 120 ->
    yystate(102, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(99, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(99, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 114 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 108 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 114 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(81, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(81, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 110 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 122 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(77, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(77, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 100 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(75, [104|Ics], Line, Tlen, Action, Alen) ->
    yystate(102, Ics, Line, Tlen+1, Action, Alen);
yystate(75, [103|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(75, [102|Ics], Line, Tlen, Action, Alen) ->
...
yystate(75, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(75, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 69 ->
    yystate(102, Ics, Line, Tlen+1, Action, Alen);
yystate(75, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 77 ->
    yystate(102, Ics, Line, Tlen+1, Action, Alen);
yystate(75, [C|Ics], Line, Tlen, Action, Alen) when C >= 79, C =< 83 ->
    yystate(102, Ics, Line, Tlen+1, Action, Alen);
yystate(75, [C|Ics], Line, Tlen, Action, Alen) when C >= 85, C =< 90 ->
    yystate(102, Ics, Line, Tlen+1, Action, Alen);
...
yystate(71, [114|Ics], Line, Tlen, _, _) ->
    yystate(103, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(44, [108|Ics], Line, Tlen, _, _) ->
    yystate(99, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(44, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(44, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 119 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 114 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(34, [C|Ics], Line, Tlen, _, _) when C >= 116, C =< 118 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 107 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 99, C =< 122 ->
    yystate(102, Ics, Line, Tlen+1, 7, Tlen);
